...
class SchedulePickupScreen extends StatefulWidget {
  ...
  const SchedulePickupScreen({Key? key, required this.imageAddress, required this.courierName, required this.deliveryDuration, required this.charges, required this.packageWeight, required this.packageValue, required this.shipmentType}) : super(key: key);
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.symmetric(
                              vertical: screenHeight * 0.02, horizontal: screenWidth * 0.056),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              PickupTimeBuilder(screenHeight: screenHeight, screenWidth: screenWidth),
                            ],
                          ),
                        ),
